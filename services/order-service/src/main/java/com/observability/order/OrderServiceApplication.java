...
public class OrderServiceApplication {
    ...
    private static void initializeDatabase() {
        ...
        System.out.println("OrderService: Creating database '" + databaseName + "' if it does not exist...");
        ...
        while (retryCount < maxRetries) {
            try (Connection conn = DriverManager.getConnection(initUrl, username, password)) {
                ...
                try (Statement createStmt = conn.createStatement()) {
                    ...
                    System.out.println("OrderService: CREATE DATABASE statement executed for '" + databaseName + "'");
                ...
                try (Connection verifyConn = DriverManager.getConnection(verifyUrl, username, password);
                    ...
                    if (rs.next() && rs.getInt(1) == 1) {
                        System.out.println("OrderService: Database '" + databaseName + "' verified and ready.");
                ...
                retryCount++;
                System.out.println("OrderService: Attempt " + retryCount + "/" + maxRetries + " - Failed: " + e.getMessage());
